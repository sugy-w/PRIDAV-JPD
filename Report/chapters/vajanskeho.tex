...
Táto trasa spája mestské centrum s rekreačnými oblasťami a zároveň poskytuje alternatívnu cestu pre dochádzajúcich cyklistov.
...
Sčítače na Vajanského nábreží poskytujú dáta až od konca januára 2024. Do osadenia nových sčítačov na Vajanského, 
mesto vychádzalo z čísel cyklosčítačov pri River Parku. Pre zachytenie vývoja cyklistickej dopravy pred 
...
\begin{figure}[H]
    ...
    \caption{Prehľad analyzovaných cyklotrás}
    \label{obr2.1}
\end{figure}
...
ktorá nadobúda hodnotu \texttt{1} v období po otvorení cyklotrasy a \texttt{0} v období pred ním.
...
ktorá nadobúda hodnotu \texttt{1} pre soboty a nedele a \texttt{0} pre pracovné dni.
...
spôsobený sezónnosťou. Z tohto dôvodu boli použité HAC smerodajné chyby podľa Newey--West, ktoré poskytujú 
